...
const Home = () => {
  ...
  const requestsfetch = async () => {
    try {
      const res = await fetch(`${BACKEND_URL}/api/connections/getconreq`, {
        method: "GET",
  ...
  const requestCon = async (reqId) => {
    try {
      const res = await fetch(`${BACKEND_URL}/api/connections/reqcon`, {
        method: "POST",
        headers: {
  ...
  const acceptRequest = async (reqId) => {
    try {
      const res = await fetch(`${BACKEND_URL}/api/connections/acceptcon`, {
        method: "POST",
        headers: {
          Authorization: `Bearer ${token}`,
          "Content-Type": "application/json",
  ...
  const rejectRequest = async (reqId) => {
    try {
      const res = await fetch(`${BACKEND_URL}/api/connections/rejectcon`, {
        method: "POST",
        headers: {
          Authorization: `Bearer ${token}`,
          "Content-Type": "application/json",
  ...
  const fetchConnections = async () => {
    try {
      const res = await fetch(`${BACKEND_URL}/api/connections/getcon`, {
        method: "GET",
        headers: { Authorization: `Bearer ${token}` },
      });
      const data = await res.json();
